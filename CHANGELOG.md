...
- Added fixed-artifact JavaScript, TypeScript, and browser consumer checks and M9 accessibility review. Real Safari remains unverified on the available Windows host.

This is an unpublished beta candidate in source control, not an npm publication. The existing npm `latest` tag still points to 1.x. See [the migration guide](docs/v2/migration.md) and [M9 gate](docs/implementation/m9-plan.md).
