		...
		"cont" : {
			...
			"pointcuts" : {
				...
				"regexp" : {
					 ...
					 * cont : 컨트롤러 객체
					 * fnChain : 컨트롤러에 정의된 함수체인(뷰의selector.:functionName.functionName...)(Built-in 함수를 제외한 사용자가 정의한 함수만 대상으로 한다)
					 */
			...
			},
			{
				"pointcut" : "after.*",
				"adviceType" : "after",
				"fn" : function(cont, fnChain, args, result){ /* cont 컨트롤러, fnChain 함수체인, args 인자, 반환값 */
