...
declare class NC {
     ...
     *
     * @param {string | number | T} idx - The index or identifier of the element to be removed. The type 'T' represents a generic type parameter.
     ...
     */
    vals(vals?: string | string[] | NC.ValsCallback): string | string[] | N<HTMLElement[]> | this;
    /**
     ...
     *
     * @param {...T} args - The arguments to be passed to each deferred task.
    ...
    static element: {
         ...
         */
        toOpts(ele: N<HTMLElement[]>): string;
        /**
         ...
         */
        toRules(ele: N<HTMLElement[]>, ruleset: "format" | "validate"): NC.RuleObj;
        /**
         ...
         */
        toData(eles: N<HTMLElement[]>): JSONObject;
