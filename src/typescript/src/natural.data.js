...
N.prototype.datafilter = function(condition) {
	return N.data.filter(this, condition);
};
N.prototype.datasort = function(key, reverse) {
	return N.data.sort(this, key, reverse);
};
N.prototype.formatter = function(rules) {
	return new N.formatter(this, rules);
};
N.prototype.validator = function(rules) {
...
// DataSync(N.ds)
N.ds.constructor = function(inst, isReg) {
...
N.ds.instance = function(inst, isReg) {
...
N.ds.prototype.notify = function(row, key) {
	var inst = this.inst;
	var observable = this.observable;
	if (inst && observable) {
		for (var i = 0; i < observable.length; i++) {
...
// Formatter
N.formatter.constructor = function(obj, rules) {
	this.options = {
...
N.formatter.prototype.format = function(row) {
	var opts = this.options;
	var self = this;
	var retArr = [];
	var retObj;
	...
	$(opts.data).each(function(i, obj) {
		...
		for ( var k in opts.rules ) {
			...
			$(opts.rules[k]).each(function() {
				try {
					tempValue = N.formatter[N.string.trimToEmpty(this[0]).toLowerCase()](tempValue, N(this).remove_(0).toArray(), ele);
				} catch (e) {
...
N.formatter.prototype.unformat = function(row, key) {
	return this.options.data[row][key];
};

N.formatter.commas = function(str) {
	if (N.isEmpty(str)) {
		return str;
	}
	str = str.replace(/,/g, "");
 ...
 */
N.formatter.rrn = function(str, args) {
	if (N.isEmpty(str)) {
		return str;
	}
 ...
 */
N.formatter.kcn = function(str) {
	return this.rrn(str);
};
N.formatter.upper = function(str) {
	if (N.isEmpty(str)) {
		return str;
	}
	return str.toUpperCase();
};
N.formatter.lower = function(str) {
	if (N.isEmpty(str)) {
		return str;
	}
	return str.toLowerCase();
};
N.formatter.capitalize = function(str) {
	if (N.isEmpty(str)) {
		return str;
	}
...
N.formatter.zipcode = function(str) {
	if (N.isEmpty(str)) {
		return str;
	}
	str = str.replace(/[^0-9*]/g, "");
...
N.formatter.phone = function(str) {
	if (N.isEmpty(str)) {
		return str;
	}
	str = str.replace(/[^0-9*]/g, "");
...
N.formatter.realnum = function(str) {
	try {
...
N.formatter.time = function(str, args) {
	str = str.replace(/[^0-9]/g, "");
...
N.formatter.limit = function(str, args, ele) {
	if (args === undefined || args[0] === undefined) {
...
N.formatter.replace = function(str, args, ele) {
...
N.formatter.lpad = function(str, args) {
	if (args === undefined || args.length < 2) {
...
N.formatter.rpad = function(str, args) {
	if (args === undefined || args.length < 2) {
...
N.formatter.mask = function(str, args) {
...
N.formatter.generic = function(str, args) {
	if (args === undefined || args[0] === undefined) {
...
N.formatter.numeric = function(str, args) {
	if (args === undefined || args[0] === undefined) {
...
// Validator
N.validator.constructor = function(obj, rules) {
	this.options = {
		data : N.isPlainObject(obj) ? N(obj) : obj,
		rules : rules,
		isElement : false,
...
N.validator.prototype.validate = function(row) {
	var opts = this.options;
	var retArr = [];
	var retObj;
	var retTempObj;
			...
			$(opts.rules[k]).each(function() {
				...
				try {
					if (opts.rules[k].toString().indexOf("required") < 0 && rule !== "required" && N.string.isEmpty(String(obj[k]))) {
						...
						retTempObj.result = N.validator[rule](N.string.trimToEmpty(obj[k]), args);
					}
				} catch (e) {
					if (e.toString().indexOf("is not a function") > -1) {
...
N.validator.required = function(str) {
	return !N.string.isEmpty(str);
};
N.validator.alphabet = function(str) {
	return new RegExp(/^[a-z\s]+$/i).test(str);
};
N.validator.integer = function(str) {
	return new RegExp(/^[+-]?\d+$/).test(str);
};
N.validator.korean = function(str) {
	return new RegExp(/^[ㄱ-ㅎ|ㅏ-ㅣ|가-힣\s]+$/).test(str);
};
N.validator.alphabet_integer = function(str) {
	return new RegExp(/^[a-z-?\d\s]+$/i).test(str);
};
N.validator.integer_korean = function(str) {
	return new RegExp(/^[ㄱ-ㅎ|ㅏ-ㅣ|가-힣-?\d\s]+$/).test(str);
};
N.validator.alphabet_korean = function(str) {
	return new RegExp(/^[ㄱ-ㅎ|ㅏ-ㅣ|가-힣a-z\s]+$/i).test(str);
};
N.validator.alphabet_integer_korean = function(str) {
	return new RegExp(/^[ㄱ-ㅎ|ㅏ-ㅣ|가-힣a-z-?\d\s]+$/i).test(str);
};
N.validator.dash_integer = function(str) {
	return new RegExp(/^(\d|-)+$/).test(str);
};
N.validator.commas_integer = function(str) {
	return new RegExp(/^(\d|,)+$/).test(str);
};
N.validator.number = function(str) {
	return new RegExp(/^[+-]?(\d|,|\.)+$/).test(str);
};
N.validator.email = function(str) {
	return new RegExp(
			/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)*(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i)
			.test(str);
};
N.validator.url = function(str) {
	return new RegExp(
			/^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)*(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i)
			.test(str);
};
N.validator.zipcode = function(str) {
	return new RegExp(/^\d{3}-\d{3}$/).test(str);
};
N.validator.decimal = function(str, args) {
	var length = (args !== undefined && args[0] !== undefined) ? args[0] : 10;
	return new RegExp(/^-?\d+$/).test(str) || new RegExp("^-?\\d*\\.\\d{0," + String(length) + "}$").test(str);
};
N.validator.phone = function(str, args) {
	if (args !== undefined && args[0] !== undefined) {
		if (args[0] == "true") {
 ...
 * US Social Security Number
 */
N.validator.ssn = function(str) {
	return new RegExp(/\d{3}-\d{2}-\d{4}/).test(str);
};
N.validator.frn = function(str) {
	str = str.replace(/[^0-9*]/g, "");
	if (N.string.trimToEmpty(str).length !== 13) {
		str = null;
		return false;
...
N.validator.frn_rrn = function(str) {
	str = str.replace(/[^0-9*]/g, "");
	if (N.string.trimToEmpty(str).length !== 13) {
		str = null;
		return false;
...
N.validator.maxlength = function(str, args) {
	if (args === undefined || args[0] === undefined) {
...
N.validator.minlength = function(str, args) {
	if (args === undefined || args[0] === undefined) {
...
N.validator.rangelength = function(str, args) {
	if (args === undefined || args.length < 2) {
...
N.validator.maxbyte = function(str, args) {
	if (args === undefined || args[0] === undefined) {
...
N.validator.minbyte = function(str, args) {
	if (args === undefined || args[0] === undefined) {
...
N.validator.rangebyte = function(str, args) {
	if (args === undefined || args.length < 2) {
...
N.validator.maxvalue = function(str, args) {
	if (args === undefined || args[0] === undefined) {
...
N.validator.minvalue = function(str, args) {
	if (args === undefined || args[0] === undefined) {
...
N.validator.rangevalue = function(str, args) {
	if (args === undefined || args.length < 2) {
...
N.validator.regexp = function(str, args) {
	if (args === undefined || args.length < 2) {
