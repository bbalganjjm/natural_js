...
// Use jQuery init
N.prototype.constructor = function(selector, context) {
 ...
 */
N.prototype.remove_ = function(idx, length) {
    if (idx !== undefined) {
        if (!N.isNumeric(idx)) {
 ...
 */
N.prototype.instance = function(name, instance) {
 ...
 */
N.prototype.vals = function(vals) {
 ...
 */
N.prototype.events = function(eventName, namespace) {
    var ele = $(this);
 ...
 */
N.isPlainObject = $.isPlainObject;
/**
 * Check whether object is empty
 */
N.isEmptyObject = function(obj) {
...
N.mask.setGeneric = function(_v, _d) {
...
N.mask.setNumeric = function(_v, _p, _d) {
