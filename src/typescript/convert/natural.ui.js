...
N.prototype.alert = function(msg, vars) {
        return new N.alert(this, msg, vars);
};
N.prototype.button = function(opts) {
...
N.prototype.datepicker = function(opts) {
    return new N.datepicker(this, opts);
};
N.prototype.popup = function(opts) {
    return new N.popup(this, opts);
};
N.prototype.tab = function(opts) {
    return new N.tab(this, opts);
};
N.prototype.select = function(opts) {
    return new N.select(this, opts);
};
N.prototype.form = function(opts) {
    return new N.form(this, opts);
};
N.prototype.list = function(opts) {
    return new N.list(this, opts);
};
N.prototype.grid = function(opts) {
    return new N.grid(this, opts);
};
N.prototype.pagination = function(opts) {
    return new N.pagination(this, opts);
};
N.prototype.tree = function(opts) {
    ...
    render : function(i, limit, delay, lastIdx, callType) {
        ...
        if(i <= lastIdx) {
            if (opts.data.length > 0) {
                ...
                if(delay > 0) {
                    setTimeout(function() {
                        N.ui.iteration.render.call(self, i, limit, delay, lastIdx, callType);
                    }, delay);
                } else {
                    N.ui.iteration.render.call(self, i, limit, delay, lastIdx, callType);
                }
...
// Alert
N.alert.constructor = function(obj, msg, vars) {
    this.options = {
        obj : obj,
        context : obj,
        container : null,
    ...
    if(msg !== undefined && N.isPlainObject(msg)) {
        ...
        N.ui.utils.wrapHandler(msg, "alert", "onOk");
        N.ui.utils.wrapHandler(msg, "alert", "onCancel");
        N.ui.utils.wrapHandler(msg, "alert", "onBeforeShow");
        N.ui.utils.wrapHandler(msg, "alert", "onShow");
        N.ui.utils.wrapHandler(msg, "alert", "onBeforeHide");
        N.ui.utils.wrapHandler(msg, "alert", "onHide");
        N.ui.utils.wrapHandler(msg, "alert", "onBeforeRemove");
        N.ui.utils.wrapHandler(msg, "alert", "onRemove");
        N.ui.utils.wrapHandler(msg, "alert", "okButtonOpts");
        N.ui.utils.wrapHandler(msg, "alert", "cancelButtonOpts");
    ...
    if (!this.options.isInput) {
        ...
        N.alert.wrapInputEle.call(this);
...
N.alert.resetOffSetEle = function(opts) {
...
var Button = N.button = function(obj, opts) {
    ...
    if(opts !== undefined) {
        // Wraps the global event options in N.config and event options for this component.
        N.ui.utils.wrapHandler(opts, "button", "onBeforeCreate");
        N.ui.utils.wrapHandler(opts, "button", "onCreate");
...
var Datepicker = N.datepicker = function(obj, opts) {
    ...
    if(opts !== undefined) {
        // Wraps the global event options in N.config and event options for this component.
        N.ui.utils.wrapHandler(opts, "datepicker", "onChangeYear");
        N.ui.utils.wrapHandler(opts, "datepicker", "onChangeMonth");
        N.ui.utils.wrapHandler(opts, "datepicker", "onSelect");
        N.ui.utils.wrapHandler(opts, "datepicker", "onBeforeShow");
        N.ui.utils.wrapHandler(opts, "datepicker", "onShow");
        N.ui.utils.wrapHandler(opts, "datepicker", "onBeforeHide");
        N.ui.utils.wrapHandler(opts, "datepicker", "onHide");
...
var Popup = N.popup = function(obj, opts) {
    ...
    // Wraps the global event options in N.config and event options for this component.
    N.ui.utils.wrapHandler(opts, "popup", "onOk");
    N.ui.utils.wrapHandler(opts, "popup", "onCancel");
    N.ui.utils.wrapHandler(opts, "popup", "onBeforeShow");
    N.ui.utils.wrapHandler(opts, "popup", "onShow");
    N.ui.utils.wrapHandler(opts, "popup", "onBeforeHide");
    N.ui.utils.wrapHandler(opts, "popup", "onHide");
    N.ui.utils.wrapHandler(opts, "popup", "onBeforeRemove");
    N.ui.utils.wrapHandler(opts, "popup", "onRemove");
    N.ui.utils.wrapHandler(opts, "popup", "onOpen");
    N.ui.utils.wrapHandler(opts, "popup", "onClose");
    N.ui.utils.wrapHandler(opts, "popup", "onLoad");
...
var Tab = N.tab = function(obj, opts) {
    ...
    if (N.isPlainObject(obj)) {
        // Wraps the global event options in N.config and event options for this component.
        N.ui.utils.wrapHandler(opts, "tab", "onActive");
        N.ui.utils.wrapHandler(opts, "tab", "onLoad");
...
var Form = N.form = function(data, opts) {
    ...
    if (N.isPlainObject(opts)) {
        // Wraps the global event options in N.config and event options for this component.
        N.ui.utils.wrapHandler(opts, "form", "onBeforeBindValue");
        N.ui.utils.wrapHandler(opts, "form", "onBindValue");
        N.ui.utils.wrapHandler(opts, "form", "onBeforeBind");
        N.ui.utils.wrapHandler(opts, "form", "onBind");
        ...
        if (!N.isEmptyObject(opts.data) && !N.isEmptyObject(vals = opts.data[opts.row])) {
            ...
            for ( var key in vals ) {
                ...
                if (ele.length > 0) {
                    ...
                    if (N.ui.utils.isTextInput(tagName, type)) {
                        if(opts.tpBind) {
...
var List = N.list = function(data, opts) {
    ...
    if (N.isPlainObject(opts)) {
        // Wraps the global event options in N.config and event options for this component.
        N.ui.utils.wrapHandler(opts, "list", "onBeforeSelect");
        N.ui.utils.wrapHandler(opts, "list", "onSelect");
        N.ui.utils.wrapHandler(opts, "list", "onBind");
    ...
    if(this.options.select || this.options.multiselect) {
        N.ui.iteration.select.call(this, "list");
    }
...
$.extend(List, {
    createScroll : function() {
        ...
        var rowEleLength;
        N.ui.scroll.paging.call(self, contextWrapEle, defSPSize, rowEleLength, "> li", "list.bind");
    ...
    vResize : function(contextWrapEle) {
        ...
        N.ui.draggable.events.call(vResizable, eventNameSpace, function(e, tabContainerEle_, pageX, pageY) { // start
...
$.extend(List.prototype, {
    ...
    bind : function(data, callType) {
        ...
        if(!opts.isBinding) {
            ...
            if (opts.data.length > 0 || (callType === "append" && data && data.length > 0)) {
                ...
                N.ui.iteration.render.call(this, i, limit, delay, lastIdx, callType);
    ...
    move : function(fromRow, toRow) {
        N.ui.iteration.move.call(this, fromRow, toRow, "list");

        return this;
    },
    copy : function(fromRow, toRow) {
        N.ui.iteration.copy.call(this, fromRow, toRow, "list");
...
var Grid = N.grid = function(data, opts) {
    ...
    if (N.isPlainObject(opts)) {
        // Wraps the global event options in N.config and event options for this component.
        N.ui.utils.wrapHandler(opts, "grid", "onBeforeSelect");
        N.ui.utils.wrapHandler(opts, "grid", "onSelect");
        N.ui.utils.wrapHandler(opts, "grid", "onBind");
    ...
    // set selectable
    if(this.options.select || this.options.multiselect) {
        N.ui.iteration.select.call(this, "grid");
    }
    ...
    // set function for check all checkbox in list
    if(this.options.checkAll !== null && this.options.checkAllTarget !== null) {
        N.ui.iteration.checkAll.call(this, "grid");
    } else {
        if(this.options.checkSingleTarget !== null) {
            // set function for check single checkbox in list
            N.ui.iteration.checkSingle.call(this, "grid");
        }
    }
...
$.extend(Grid, {
    ...
    fixHeader : function() {
        ...
        var defSPSize = opts.scrollPaging.limit;
        var rowEleLength;
        N.ui.scroll.paging.call(self, contextWrapEle, defSPSize, rowEleLength, "> tbody", "grid.bind");
...
$.extend(Grid.prototype, {
    ...
    move : function(fromRow, toRow) {
        N.ui.iteration.move.call(this, fromRow, toRow, "grid");

        return this;
    },
    copy : function(fromRow, toRow) {
        N.ui.iteration.copy.call(this, fromRow, toRow, "grid");
...
var Pagination = N.pagination = function(data, opts) {
    ...
    if (N.isPlainObject(opts)) {
        // Wraps the global event options in N.config and event options for this component.
        N.ui.utils.wrapHandler(opts, "pagination", "onChange");
...
var Tree = N.tree = function(data, opts) {
    ...
    if (N.isPlainObject(opts)) {
        // Wraps the global event options in N.config and event options for this component.
        N.ui.utils.wrapHandler(opts, "tree", "onSelect");
        N.ui.utils.wrapHandler(opts, "tree", "onCheck");
...
$.extend(Tree.prototype, {
    ...
    collapse : function(isFirstNodeOpen) {
