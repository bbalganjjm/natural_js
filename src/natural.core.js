...
var N = function (selector, context) {
    var obj = new jquery_1.default.fn.init(selector, context);
    obj.selector = N.toSelector(selector);
    return obj;
};
jquery_1.default.fn.extend(jquery_1.default.extend(N.prototype, {
    /**
    ...
    tpBind: function () {
        ...
        return this.each(function () {
            if (jquery_1.default._data(this, "events") !== undefined) {
                self.on.apply(self, args);
                (0, jquery_1.default)(this).each(function () {
                    var handlers = jquery_1.default._data(this, "events")[args[0].split(".")[0]];
    ...
    instance: function (name, instance) {
        if (arguments.length === 0) {
            return this.map(function () {
                return jquery_1.default.map((0, jquery_1.default)(this).data(), function (v, i) {
            ...
            if (typeof name === "function") {
                return this.each(function () {
                    return jquery_1.default.each((0, jquery_1.default)(this).data(), function (i, v) {
                        if (N.string.endsWith(i, "__")) {
            ...
            if (tagName === "select") {
                ...
                if (this.length > 1) {
                    ...
                    N(vals).each(function () {
                        self_1.filter("[value='" + String(this) + "']").prop("checked", true);
                    });
                }
            ...
            if (tagName === "select") {
                ...
                if (selEle.length > 1) {
                    if (N.type(vals) !== "function") {
                        return selEle.map(function () {
                            return N.string.trimToEmpty((0, jquery_1.default)(this).val());
                        }).toArray();
                    }
                    else {
                ...
                if (this.length > 1) {
                    if (N.type(vals) !== "function") {
                        ...
                        return selEle.length === 1 ? N.string.trimToEmpty((0, jquery_1.default)(selEle).val()) : chkedVals.length === 0 ? [] : chkedVals;
                    }
                    else {
    ...
    events: function (eventName, namespace) {
        var ele = (0, jquery_1.default)(this);
        if (ele.length > 0 && jquery_1.default._data(ele.get(0), "events") !== undefined) {
            if (eventName !== undefined && namespace !== undefined) {
                var e_ = (0, jquery_1.default)(jquery_1.default._data(ele.get(0), "events")[eventName]).filter(function () {
                    return namespace === this.namespace;
                }).get();
                return N.isEmptyObject(e_) ? undefined : e_;
            }
            else if (eventName !== undefined && namespace === undefined) {
                return jquery_1.default._data(ele.get(0), "events")[eventName];
            }
            else {
                return jquery_1.default._data(ele.get(0), "events");
            }
        }
    }
}));
...
(function () {
    ...
    jquery_1.default.expr.pseudos.regexp = jquery_1.default.expr.createPseudo(function (meta) {
        if (!meta)
            return jquery_1.default.noop;
...
(function (N) {
    ...
    jquery_1.default.extend(N, {
         ...
         */
        isPlainObject: jquery_1.default.isPlainObject,
        /**
        ...
        serialExecute: function () {
            var self = this;
            self.defers = [];
            (0, jquery_1.default)(arguments).each(function (i, fn) {
                var defer = jquery_1.default.Deferred();
                self.defers.push(defer);
                if (self.defers.length > 1) {
                    self.defers[i - 1].done(function () {
                        fn.apply(self.defers, jquery_1.default.merge([defer], arguments));
                    });
                }
                else {
        ...
        gc: {
             ...
             */
            minimum: function () {
                (0, jquery_1.default)(window).off("resize.datepicker");
                (0, jquery_1.default)(window).off("resize.alert");
                (0, jquery_1.default)(document).off("click.datepicker");
                (0, jquery_1.default)(document).off("keyup.alert");
                (0, jquery_1.default)(document).off("click.grid.dataFilter");
                (0, jquery_1.default)(document).off("click.grid.more touchstart.grid.more");
                return true;
            },
            /**
             * Full collection
            ...
            full: function () {
                (0, jquery_1.default)(window).off("resize.datepicker");
                (0, jquery_1.default)(window).off("resize.alert");
                (0, jquery_1.default)(document).off("dragstart.alert selectstart.alert mousemove.alert touchmove.alert mouseup.alert touchend.alert");
                (0, jquery_1.default)(document).off("click.datepicker");
                (0, jquery_1.default)(document).off("keyup.alert");
                (0, jquery_1.default)(document).off("dragstart.grid.vResize selectstart.grid.vResize mousemove.grid.vResize touchmove.grid.vResize mouseup.grid.vResize touchend.grid.vResize");
                (0, jquery_1.default)(document).off("dragstart.grid.resize selectstart.grid.resize mousemove.grid.resize touchmove.grid.resize mouseup.grid.resize touchend.grid.resize");
                (0, jquery_1.default)(document).off("click.grid.dataFilter");
                (0, jquery_1.default)(document).off("click.grid.more touchstart.grid.more");
                return true;
            },
             ...
             */
            ds: function () {
                if ((0, jquery_1.default)(N.context.attr("architecture").page.context).find(">#data_sync_temp__").length > 0) {
                    (0, jquery_1.default)(N.context.attr("architecture").page.context).find(">#data_sync_temp__").instance("ds").obserable
                        = jquery_1.default.uniqueSort((0, jquery_1.default)(".grid__, .list__, .form__:not('.grid__>tbody, .list__>li'), .tree__", N.context.attr("architecture").page.context).instance());
                }
            }
        },
        /**
        ...
        "date": {
            ...
            strToDateStrArr: function (str, format, isString) {
                ...
                if (isString === undefined || isString === false) {
                    (0, jquery_1.default)(dateStrArr).each(function (i) {
            ...
            strToDate: function (str, format) {
                ...
                if (str.length > 2 && str.length <= 4) {
                    ...
                    dateStrArr = N.date.strToDateStrArr(str, format.replace(/[^Y|^m|^d]/g, ""));
                    dateInfo = {
                        obj: new Date(dateStrArr[0], dateStrArr[1] - 1, dateStrArr[2], str.substring(8, 10), str.substring(10, 12), 0),
                        format: format
                    };
                }
                    ...
                    dateStrArr = N.date.strToDateStrArr(str, format.replace(/[^Y|^m|^d]/g, ""));
                    dateInfo = {
                        obj: new Date(dateStrArr[0], dateStrArr[1] - 1, dateStrArr[2], str.substring(8, 10), str.substring(10, 12), str.substring(12, 14)),
                        format: format
                    };
                }
                return dateInfo;
            ...
            dateList: function (year, month) {
                ...
                for (var i = 1, length_1 = daysOfLastWeek.length; i <= 7 - length_1; i++) {
                    nextDate.setDate(i);
        ...
        "element": {
            ...
            toRules: function (ele, ruleset) {
                ...
                var id;
                ele.each(function () {
                    thisEle = (0, jquery_1.default)(this);
            ...
            toData: function (eles) {
                var retData = {};
                var key, ele;
                var beforeCheckboxNRadios = (0, jquery_1.default)();
                eles.each(function () {
                    key = (0, jquery_1.default)(this).attr("id");
                    ele = (0, jquery_1.default)(this);
            ...
            maxZindex: function (ele) {
                if (ele === undefined) {
                    ele = (0, jquery_1.default)("div, span, ul, p, nav, article, section");
                }
                return Math.max.apply(null, jquery_1.default.map(ele, function (e, n) {
                    var zIndex = parseInt((0, jquery_1.default)(e).css("z-index"));
                    if (zIndex >= 2147483647) {
                        (0, jquery_1.default)(e).css("z-index", String(2147483647 - 999));
                        (0, jquery_1.default)(e).attr("fixed", "[Natural-JS]limited_z-index_value(-999)");
                    }
                    return zIndex || 0;
                }));
            }
        ...
        "browser": {
            ...
            scrollbarWidth: function () {
                var div = (0, jquery_1.default)('<div class="antiscroll-inner" style="width:50px;height:50px;overflow-y:scroll;' +
                    'position:absolute;top:-200px;left:-200px;"><div style="height:100px;width:100%"/>' +
                    '</div>');
                (0, jquery_1.default)("body").append(div);
                var w1 = (0, jquery_1.default)(div).innerWidth();
                var w2 = (0, jquery_1.default)("div", div).innerWidth();
                (0, jquery_1.default)(div).remove();
                return w1 - w2;
            }
        },
        /**
        ...
        "array": {
            ...
            "deduplicate": function (arr, key) {
                var rtnArr = [];
                (0, jquery_1.default)(arr).each(function (i, obj) {
                    if (N.type(obj) === "object" && key !== undefined) {
                        if (jquery_1.default.inArray(obj[key], (0, jquery_1.default)(rtnArr).map(function () {
                            return this[key];
                        }).get()) < 0) {
                            rtnArr.push(obj);
                        }
                        ...
                        if (jquery_1.default.inArray(obj, rtnArr) < 0) {
                            rtnArr.push(obj);
                        }
                    }
                });
        ...
        "json": {
            "mapFromKeys": function (obj) {
                if (arguments.length > 1) {
                    var args_1 = Array.prototype.slice.call(arguments, 0);
                    if (N.context.attr("core").excludeMapFromKeys !== undefined) {
                        args_1 = args_1.concat(N.context.attr("core").excludeMapFromKeys);
                    }
                    if (N.type(obj) === "array") {
                        if (obj.length === 0) {
                            return obj;
                        }
                        return (0, jquery_1.default)(obj).map(function () {
                            var retObj = {};
                            for (var i = 1, length_2 = args_1.length; i < length_2; i++) {
                                if (args_1[i] !== undefined && this[args_1[i]] !== undefined) {
                                    retObj[args_1[i]] = this[args_1[i]];
                                }
                            }
                            return retObj;
                        }).get();
                        ...
                        var retObj = {};
                        for (var i = 1, length_3 = args_1.length; i < length_3; i++) {
                            if (args_1[i] !== undefined && obj[args_1[i]] !== undefined) {
                                retObj[args_1[i]] = obj[args_1[i]];
                            }
                        }
                        return retObj;
                    }
            ...
            "mergeJsonArray": function (arr1, arr2, key) {
                var keySet = (0, jquery_1.default)(arr1).map(function () {
                    return this[key];
                }).get().join(",");
                (0, jquery_1.default)(arr2).each(function () {
        ...
        "event": {
                ...
                if (key && !((key >= 48 && key <= 57) || (key >= 96 && key <= 105))) {
                    ...
                    // Allow: Special Keys
                        ...
                        // DisAllow : "#" & "$" & "%"
                            ...
                            return !(e.shiftKey && (key == 35 || key == 36 || key == 37));
                    }
                    else {
                        return false;
                    }
            ...
            windowScrollLock: function (ele) {
                ele.on("mousewheel.ui DOMMouseScroll.ui", function (e) {
                    ...
                    if (delta > 0 && (0, jquery_1.default)(this).scrollTop() <= 0)
                        return false;
                    return !(delta < 0 && (0, jquery_1.default)(this).scrollTop() >= this.scrollHeight - (0, jquery_1.default)(this).height());
                });
            },
            /**
            ...
            getMaxDuration: function (ele, css) {
                ...
                return Math.max.apply(undefined, (0, jquery_1.default)(ele.css(css).split(",")).map(function () {
