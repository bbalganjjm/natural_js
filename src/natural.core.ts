 ...
 *
 * @param N - The main object to extend.
 */
$.extend(N, {
    version : {
        "Natural-CORE" : "1.0.0"
    ...
    "date" : {
         ...
         */
        strToDate : function(str: string, format?: string): N.NDate {
            ...
            if (str.length > 2 && str.length <= 4) {
                ...
                dateStrArr = N.date.strToDateStrArr(str, format.replace(/[^Y|^m|^d]/g, ""));
                dateInfo = {
                    obj : new Date(dateStrArr[0], dateStrArr[1]-1, dateStrArr[2], Number(str.substring(8, 10)), Number(str.substring(10, 12)), 0),
                    format : format
                };
                ...
                dateStrArr = N.date.strToDateStrArr(str, format.replace(/[^Y|^m|^d]/g, ""));
                dateInfo = {
                    obj : new Date(dateStrArr[0], dateStrArr[1]-1, dateStrArr[2], Number(str.substring(8, 10)), Number(str.substring(10, 12)), Number(str.substring(12, 14))),
                    format : format
                };
            }
            return dateInfo;
         ...
         */
        format : function(str: string, format: string): string {
            const dateInfo: N.NDate = this.strToDate(str);
         ...
         */
        dateToTs : function(dateObj: Date) {
            let d: Date = dateObj;
            if (d === undefined) {
                d = new Date();
            }
