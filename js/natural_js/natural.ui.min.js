			...
			if(this.options.select || this.options.multiselect) {
				...
				this.tbodyTemp.bind("click.grid.tbody", function() {
					...
					if(this_.options.onSelect !== null) {
						retFlag = this_.options.onSelect.call(thisEle, this_.options.row, thisEle, this_.options.data, this_.options.beforeRow);
					}
					...
					if(retFlag === undefined || retFlag === true) {
						if(selected) {
							...
							if(!this_.options.multiselect) {
								this_.options.context.find("> tbody:eq(" + this_.options.beforeRow + ")").removeClass("grid_selected__");
							}
							thisEle.addClass("grid_selected__");
							this_.options.beforeRow = this_.options.row;
						}
					}
				});
			}
