...
(function(window, $) {
	...
	$.fn.extend(N, {
		...
		"date" : {
			 ...
			 */
			strToDateStrArr : function(str, format) {
				var dateStrArr = [];
				if(N.string.startsWith(format, "Ymd")) {
					dateStrArr.push(parseInt(str.substring(0, 4))); //year
					dateStrArr.push(parseInt(str.substring(4, 6))); //month
					dateStrArr.push(parseInt(str.substring(6, 8))); //day
        		} else if(N.string.startsWith(format, "mdY")) {
        			dateStrArr.push(parseInt(str.substring(4, 8)));
        			dateStrArr.push(parseInt(str.substring(0, 2)));
        			dateStrArr.push(parseInt(str.substring(2, 4)));
        		} else if(N.string.startsWith(format, "dmY")) {
        			dateStrArr.push(parseInt(str.substring(4, 8)));
        			dateStrArr.push(parseInt(str.substring(2, 4)));
        			dateStrArr.push(parseInt(str.substring(0, 2)));
        		} else if(N.string.startsWith(format, "Ym")) {
        			dateStrArr.push(parseInt(str.substring(0, 4)));
					dateStrArr.push(parseInt(str.substring(4, 6)));
        		} else if(N.string.startsWith(format, "mY")) {
        			dateStrArr.push(parseInt(str.substring(2, 6)));
					dateStrArr.push(parseInt(str.substring(0, 2)));
        		} else {
			...
			strToDate : function(str, format) {
				...
				if (str.length > 2 && str.length <= 4) {
					...
					var dateStrArr = N.date.strToDateStrArr(str, format.replace(/[^Y|^m|^d]/g, ""));
					dateInfo = {
