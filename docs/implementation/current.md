...
- Safari is outside the initial 2.0 support scope by user decision. Chrome and Edge packed-artifact smokes passed on Windows; Playwright WebKit is reported separately as engine evidence.
