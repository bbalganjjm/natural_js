...
- M0-M4 are complete and pushed to branch `2.0.0-alpha.0`; the M4 screen, measurements, and final checks are recorded. M5 is a draft requiring separate approval. See [current.md](current.md).
