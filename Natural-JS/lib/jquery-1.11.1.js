...
(function(global, factory) {
	...
	(
		...
		function(window, noGlobal) {
			 ...
			 *
			 * @param {Function}
			 *                fn Passed the created div and expects
			 *                a boolean result
			 */
			function assert(fn) {
			 ...
			 *
			 * @param {String}
			 *                attrs Pipe-separated list of
			 *                attributes
			 * @param {Function}
			 *                handler The method that will be
			 *                applied
			 */
			 ...
			 *
			 * @param {Element|Object}
			 *                [doc] An element or document object to
			 ...
			 *                [results]
			 * @param {Array}
			 *                [seed] A set of elements to match
			 *                against
			 */
