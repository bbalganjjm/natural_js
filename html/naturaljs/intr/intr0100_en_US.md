...
위 그림과 같이 Natural Architecture Framework 는 각 영역들을 명확하게 구분 할 수 있는 기반을 제공하여 각 영역별 전문가들로 분업하여 웹 개발 프로젝트를 진행 할 수 있습니다.
