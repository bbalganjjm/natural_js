...
(function () {
    const cont = N(".type0601").cont({
        ...
        "c.getSampleDeptList": () => N.comm("sample/getSampleDeptList.json"),
        "c.getSampleList": (params) => N(params).comm("sample/getSampleList.json"),
        "c.saveSample": () => N(cont["p.grid.detail"].data("modified")).comm({
        ...
        "e.btnDelete.click": function (e) {
            e.preventDefault();
            return window.APP.comm.utils.del.call(this, {
                cont: cont,
                inst: "p.grid.detail"
            });
        },
