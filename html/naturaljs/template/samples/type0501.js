    ...
    const cont = N(".type0501").cont({
        ...
        "p.form.detail": {
            ...
            onBind: function (context, rowData) {
                // 2.3. 로딩바 업데이트
                N.docs.updateLoadIndicator.call(window.APP.indx.docs, 0, 2);
                // 3. 로딩바 제거
                N.docs.removeLoadIndicator.call(window.APP.indx.docs);
            }
        },
        "p.list.codeMaster": {
            height: 463,
            ...
            onBind: function (context, data, isFirstPage, isLastPage) {
                ...
                // 2.2. 로딩바 업데이트
                N.docs.updateLoadIndicator.call(window.APP.indx.docs, 1, 2);
            }
        },
        "p.grid.master": {
            height: 486,
            ...
            onBind: function (context, data, isFirstPage, isLastPage) {
                ...
                // 2.1. 로딩바 업데이트
                N.docs.updateLoadIndicator.call(window.APP.indx.docs, 2, 2);
            }
        },
        "p.popup.dept": {
        ...
        "e.btnSearch.click": function (e) {
            e.preventDefault();
            // 1. 로딩바 생성
            N.docs.createLoadIndicator.call(window.APP.indx.docs);
