...
*/
(function(A,h){N.version["Natural-DATA"]="0.11.73";h.fn.extend(h.extend(N.prototype,{datafilter:function(c){return N.data.filter(this,c)},datasort:function(c,v){return N.data.sort(this,c,v)},formatter:function(c){return new N.formatter(this,c)},validator:function(c){return new N.validator(this,c)}}));(function(c){c.data={filter:function(a,b){if("function"===c.type(b))return c.isWrappedSet(a)?c(h.grep(a.toArray(),b)):h.grep(a,b);if("string"===c.type(b)){b=b.replace(/ /g,"").replace(/\|\|/g," || item.").replace(/&&/g,
