...
a=a.replace(/,/g,"");var b=/(^[+-]?\d+)(\d{3})/;for(a+="";b.test(a);)a=a.replace(b,"$1,$2");return a},rrn:function(a,b){if(c.isEmptyObject(a))return a;a=a.replace(/[^0-9*]/g,"");if(13===a.length){var d="*";void 0!==b&&void 0!==b[1]&&(d=b[1]);void 0!==b&&void 0!==b[0]&&(a=c.string.rpad(a.substring(0,13-Number(b[0])),13,d));a=a.substring(0,6)+"-"+a.substring(6,13)}return a},ssn:function(a,b){return 9===a.length?(a=a.replace(/[^0-9*]/g,""),a.substr(0,3)+"-"+a.substr(3,2)+"-"+a.substr(5,4)):a},kbrn:function(a){if(5>
c.string.trimToEmpty(a).length)return a;a=a.replace(/[^0-9*]/g,"");10<a.length&&(a=a.substring(0,10));return a.substring(0,3)+"-"+a.substring(3,5)+"-"+a.substring(5,10)},kcn:function(a){return this.rrn(a)},upper:function(a){return c.isEmptyObject(a)?a:a.toUpperCase()},lower:function(a){return c.isEmptyObject(a)?a:a.toLowerCase()},capitalize:function(a){if(c.isEmptyObject(a))return a;var b=a.substring(0,1).toUpperCase();1<a.length&&(b+=a.substring(1));return b},zipcode:function(a){if(c.isEmptyObject(a))return a;
a=a.replace(/[^0-9*]/g,"");return a.substring(0,3)+"-"+a.substring(3,6)},phone:function(a){if(c.isEmptyObject(a))return a;a=a.replace(/[^0-9*]/g,"");return a.replace(/(^02.{0}|^01.{1}|[0-9*]{3})([0-9*]+)([0-9*]{4})/,"$1-$2-$3")},realnum:function(a){try{a=String(parseFloat(a))}catch(b){return a}return"NaN"===a?a.replace("NaN",""):a},trimtoempty:function(a){return c.string.trimToEmpty(a)},trimtozero:function(a){return c.string.trimToZero(a)},trimtoval:function(a,b){if(void 0===b||void 0===b[0])throw c.error("[N.formatter.trimtoval]You must input args[0](default value)");
return c.string.trimToVal(a,b[0])},date:function(a,b,d){if(void 0===b)return a;a=a.replace(/[^0-9]/g,"");if(void 0!==c.datepicker){if(void 0!==b[1]&&("date"===b[1]||"month"===b[1])&&void 0!==d&&!d.hasClass("datepicker__")&&d.is("input")){var e,g,k,f={monthonly:"month"===b[1]};void 0!==b[2]&&h.extend(f,b[2]);var l=d.datepicker(f).options,p=l.onBeforeShow;l.onBeforeShow=function(q,w){q.trigger("unformat");if(null!==p)return p.apply(this,arguments)};var m=l.onSelect;l.onSelect=function(q,w,z){e=w.obj.formatDate(z?
"Ym":"Ymd");q.parents(".form__").each(function(){g=h(this).instance("form");if(void 0!==g)return!1});k=q.attr("id");void 0!==g&&e!==g.val(k)&&g.val(k,e);if(null!==m)return m.apply(this,arguments)};var n=l.onBeforeHide;l.onBeforeHide=function(q,w){q.val(q.val().replace(/[^0-9]/g,""));q.trigger("focusout.dataSync.form").trigger("focusout.form.format");if(null!==n)return n.apply(this,arguments)};var r=l.onHide;l.onHide=function(q,w){if(null!==r)return r.apply(this,arguments)};if(l.yearChangeInput){var u=
...
return c.string.lpad(a,Number(b[0]),b[1])},rpad:function(a,b){if(void 0===b||2>b.length)throw c.error("[N.formatter.rpad]You must input args[0](fill length) and  args[1](replace string)");return c.string.rpad(a,Number(b[0]),b[1])},mask:function(a,b){if(void 0===b||1>b.length)throw c.error("[N.formatter.rpad]You must input args[0](masking rule)");var d="*";2!==b.length||c.string.isEmpty(b[1])||(d=b[1]);if("phone"===b[0]){a=c.string.trimToEmpty(a);var e=this.phone(a);a=e.substring(0,e.indexOf("-")+
