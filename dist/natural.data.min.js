...
*/
(function(A,h){N.version["Natural-DATA"]="0.11.72";h.fn.extend(h.extend(N.prototype,{datafilter:function(c){return N.data.filter(this,c)},datarefine:function(c){return N.data.refine(this,c)},datasort:function(c,w){return N.data.sort(this,c,w)},formatter:function(c){return new N.formatter(this,c)},validator:function(c){return new N.validator(this,c)}}));(function(c){c.data={refine:function(a,b){if(c.isWrappedSet(a))return 1==a.length?c.isPlainObject(a.get(0))?c(this.refine(a.get(0),b)):a:c(this.refine(a.toArray(),
...
e=e[a];Number(d)&&Number(e)&&(d=Number(d),e=Number(e));return d<e?-1*b:d>e?1*b:0}},sort:function(a,b,d){return a.sort(this.sortBy(b,d?-1:1))}};var w=c.ds=function(a,b){if(c.ds.caller!=c.ds.instance)throw Error("[N.datasync]There is no public constructor for N.ds, use instance method");var d=h(c.context.attr("architecture").page.context);0===d.length&&c.warn('[N.ds]Context element is missing. Please specify the correct Natural-JS\'s main context element selector to "N.context.attr("architecture").page.context" property in "natural.config.js" file');
var e=d.find("var#data_sync_temp__");0===e.length&&(e=d.append('<var id="data_sync_temp__"></var>').find("var#data_sync_temp__"));this.viewContext=e;d=this.viewContext.instance("ds");void 0!==d?(d.inst=a,void 0!==b&&!0===b&&d.observable.push(a)):(d=this,d.inst=a,d.observable=[],d.observable.push(a),this.viewContext.instance("ds",d));return d};h.extend(w,{instance:function(a,b){return new c.ds(a,b)}});h.extend(w.prototype,{remove:function(){var a=this.inst,b=this.observable;if(a&&b)for(var d=0;d<b.length;d++)b[d]==
...
return c.string.trimToVal(a,b[0])},date:function(a,b,d){if(void 0===b)return a;a=a.replace(/[^0-9]/g,"");if(void 0!==c.datepicker){if(void 0!==b[1]&&("date"===b[1]||"month"===b[1])&&void 0!==d&&!d.hasClass("datepicker__")&&d.is("input")){var e,g,k,f={monthonly:"month"===b[1]?!0:!1};void 0!==b[2]&&h.extend(f,b[2]);var l=d.datepicker(f).options,p=l.onBeforeShow;l.onBeforeShow=function(q,r){0<r.closest(".view_context__").length&&"relative"!==r.closest(".view_context__").css("position")&&"absolute"!==
r.closest(".view_context__").css("position")&&"sticky"!==r.closest(".view_context__").css("position")?(r.closest(".view_context__").css("position","relative"),r.closest(".context_wrap__").css("position","relative"),this.isApplyRelative=!0):this.isApplyRelative=!1;q.trigger("unformat");if(null!==p)return p.apply(this,arguments)};var m=l.onSelect;l.onSelect=function(q,r,z){e=r.obj.formatDate(z?"Ym":"Ymd");q.parents(".form__").each(function(){g=h(this).instance("form");if(void 0!==g)return!1});k=q.attr("id");
void 0!==g&&e!==g.val(k)&&g.val(k,e);if(null!==m)return m.apply(this,arguments)};var n=l.onBeforeHide;l.onBeforeHide=function(q,r){q.val(q.val().replace(/[^0-9]/g,""));q.trigger("focusout.dataSync.form").trigger("focusout.form.format");if(null!==n)return n.apply(this,arguments)};var t=l.onHide;l.onHide=function(q,r){!0===this.isApplyRelative&&(q.closest(".context_wrap__").css("position",""),q.closest(".view_context__").css("position",""),this.isApplyRelative=!1);if(null!==t)return t.apply(this,arguments)};
if(l.yearChangeInput){var v=l.onChangeYear;l.onChangeYear=function(){l.context.trigger("focusout.dataSync.form");if(null!==v)return v.apply(this,arguments)}}if(l.monthChangeInput){var u=l.onChangeMonth;l.onChangeMonth=function(){l.context.trigger("focusout.dataSync.form");if(null!==u)return u.apply(this,arguments)}}}}else c.warn("if you use date or month option, you must import Natural-UI library");if(void 0!==b[0])return d=c.context.attr("data").formatter.date,b="number"===c.type(b[0])?4===b[0]?
...
new RegExp(b[0],b[1]):new RegExp(b[0])).test(a)}});h.extend(y.prototype,{validate:function(a){var b=this.options,d=[],e,g,k,f=0<b.data.length?b.data:c(c.element.toData(b.targetEle));if(void 0!==a)if(a<f.length&&0<=a)f=[f[a]];else throw c.error("[N.validator.prototype.validate]Row index out of range");else b.isElement&&(f=[f[0]]);var l,p;h(f).each(function(m,n){e={};for(var t in b.rules){k=[];var v=!0;h(b.rules[t]).each(function(){g={};g.rule=this.toString();l=c(this).remove_(0).toArray();p=c.string.trimToEmpty(this[0]).toLowerCase();
-1<p.indexOf("+")&&(p=p.split("+").sort().toString().replace(/,/g,"_"));try{0>b.rules[t].toString().indexOf("required")&&"required"!==p&&c.string.isEmpty(String(n[t]))?g.result=!0:g.result=y[p](c.string.trimToEmpty(n[t]),l)}catch(q){if(-1<q.toString().indexOf("is not a function"))throw c.error('N.validator.prototype.validate("'+this[0]+'" is invalid format rule)');throw c.error("N.validator.prototype.validate",q);}g.msg=null;if(!g.result){var u;(u=c.context.attr("data").validator.message[c.locale()][p])||
(u=c.context.attr("data").validator.message[c.locale()].global);g.msg=c.message.replaceMsgVars(u,l);v=!1}k.push(g)});if(b.isElement)if(m=b.targetEle.is("input:radio, input:checkbox")?b.targetEle.filter("[name='"+t+"'].select_template__"):b.targetEle.filter("#"+t),v)if(m.removeClass("validate_false__"),void 0!==c().alert)alertInst=m.instance("alert"),void 0!==alertInst&&alertInst.remove();else throw c.error("[N.validator.prototype.validate]You must import Natural-UI library");else if(m.addClass("validate_false__"),
void 0!==c().alert)c(null!==b.targetEle?m:void 0).alert(h(k).map(function(){if(void 0!==this.msg)return this.msg}).get()).show();else throw c.error("[N.validator.prototype.validate]You must import Natural-UI library");e[t]=k}d.push(e);e=null});return d}})})(N)})(window,jQuery);
