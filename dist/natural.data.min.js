...
*/
(function(A,h){N.version["Natural-DATA"]="0.11.73";h.fn.extend(h.extend(N.prototype,{datafilter:function(c){return N.data.filter(this,c)},datasort:function(c,v){return N.data.sort(this,c,v)},formatter:function(c){return new N.formatter(this,c)},validator:function(c){return new N.validator(this,c)}}));(function(c){c.data={filter:function(a,b){if("function"===typeof b)return c.isWrappedSet(a)?c(h.grep(a.toArray(),b)):h.grep(a,b);if("string"===c.type(b)){b=b.replace(/ /g,"").replace(/\|\|/g," || item.").replace(/&&/g,
...
b));return this}});var x=c.formatter=function(a,b){this.options={data:c.isPlainObject(a)?c(a):a,rules:b,isElement:!1,createEvent:!0,context:null,targetEle:c()};if(c.isElement(b)||c.isString(b)){var d=this.options;d.isElement=!0;d.context=c(b);if(0<a.length){if(void 0!==a[0][d.context.attr("id")])d.targetEle.push(d.context.get(0));else for(var e in a[0])0<d.context.find("#"+e).length&&d.targetEle.push(d.context.find("#"+e).get(0));d.rules=c.element.toRules(d.targetEle,"format")}}};h.extend(x,{commas:function(a,
b){if(c.isEmptyObject(a))return a;a=a.replace(/,/g,"");b=/(^[+-]?\d+)(\d{3})/;for(a+="";b.test(a);)a=a.replace(b,"$1,$2");return a},rrn:function(a,b){if(c.isEmptyObject(a))return a;a=a.replace(/[^0-9*]/g,"");if(13===a.length){var d="*";void 0!==b&&void 0!==b[1]&&(d=b[1]);void 0!==b&&void 0!==b[0]&&(a=c.string.rpad(a.substring(0,13-Number(b[0])),13,d));a=a.substring(0,6)+"-"+a.substring(6,13)}return a},ssn:function(a,b){return 13===a.length?this.rrn(a,b):9===a.length?(a=a.replace(/[^0-9*]/g,""),a.substr(0,
3)+"-"+a.substr(3,2)+"-"+a.substr(5,4)):a},kbrn:function(a,b){if(5>c.string.trimToEmpty(a).length)return a;a=a.replace(/[^0-9*]/g,"");10<a.length&&(a=a.substring(0,10));return a.substring(0,3)+"-"+a.substring(3,5)+"-"+a.substring(5,10)},kcn:function(a,b){return this.rrn(a)},upper:function(a,b){return c.isEmptyObject(a)?a:a.toUpperCase()},lower:function(a,b){return c.isEmptyObject(a)?a:a.toLowerCase()},capitalize:function(a,b){if(c.isEmptyObject(a))return a;b=a.substring(0,1).toUpperCase();1<a.length&&
(b+=a.substring(1));return b},zipcode:function(a,b){if(c.isEmptyObject(a))return a;a=a.replace(/[^0-9*]/g,"");return a.substring(0,3)+"-"+a.substring(3,6)},phone:function(a,b){if(c.isEmptyObject(a))return a;a=a.replace(/[^0-9*]/g,"");return a.replace(/(^02.{0}|^01.{1}|[0-9*]{3})([0-9*]+)([0-9*]{4})/,"$1-$2-$3")},realnum:function(a,b){try{a=String(parseFloat(a))}catch(d){return a}return"NaN"===a?a.replace("NaN",""):a},trimtoempty:function(a,b){return c.string.trimToEmpty(a)},trimtozero:function(a,
b){return c.string.trimToZero(a)},trimtoval:function(a,b){if(void 0===b||void 0===b[0])throw c.error("[N.formatter.trimtoval]You must input args[0](default value)");return c.string.trimToVal(a,b[0])},date:function(a,b,d){if(void 0===b)return a;a=a.replace(/[^0-9]/g,"");if(void 0!==c.datepicker){if(void 0!==b[1]&&("date"===b[1]||"month"===b[1])&&void 0!==d&&!d.hasClass("datepicker__")&&d.is("input")){var e,g,k,f={monthonly:"month"===b[1]};void 0!==b[2]&&h.extend(f,b[2]);var l=d.datepicker(f).options,
p=l.onBeforeShow;l.onBeforeShow=function(q,w){q.trigger("unformat");if(null!==p)return p.apply(this,arguments)};var m=l.onSelect;l.onSelect=function(q,w,z){e=w.obj.formatDate(z?"Ym":"Ymd");q.parents(".form__").each(function(){g=h(this).instance("form");if(void 0!==g)return!1});k=q.attr("id");void 0!==g&&e!==g.val(k)&&g.val(k,e);if(null!==m)return m.apply(this,arguments)};var n=l.onBeforeHide;l.onBeforeHide=function(q,w){q.val(q.val().replace(/[^0-9]/g,""));q.trigger("focusout.dataSync.form").trigger("focusout.form.format");
...
var d="*";2!==b.length||c.string.isEmpty(b[1])||(d=b[1]);if("phone"===b[0]){a=c.string.trimToEmpty(a);var e=this.phonenum(a);a=e.substring(0,e.indexOf("-")+1);b=e.substring(e.lastIndexOf("-"),e.length);e=e.replace(a,"").replace(b,"");return a+e.replace(/\d/g,d)+b}if("email"===b[0]){if(a=c.string.trimToEmpty(a),c.validator.email(a)){b="";for(e=0;3>e;e++)b+=d;return a.replace(/@.*/,"").replace(/.{1,3}$/,b)+a.replace(/.*@/,"@")}}else{if("address"===b[0]){a=c.string.trimToEmpty(a);var g="_\uacbd\uae30_\uac15\uc6d0_\ucda9\ubd81_\ucda9\ub0a8_\uc804\ubd81_\uc804\ub0a8_\uacbd\ubd81_\uacbd\ub0a8_\uc81c\uc8fc_";
...
a.substring(1,2),e=a.substring(2,3),g=a.substring(3,4),k=a.substring(4,5),f=a.substring(5,6);b=2*b+3*d+4*e+5*g+6*k+7*f;d=a.substring(6,7);e=a.substring(7,8);g=a.substring(8,9);k=a.substring(9,10);f=a.substring(10,11);var l=a.substring(11,12);a=a.substring(12,13);b=11-(b+8*d+9*e+2*g+3*k+4*f+5*l)%11;b%=10;return b!==a?!1:!0},ssn:function(a,b){return(new RegExp(/\d{3}-\d{2}-\d{4}/)).test(a)},frn:function(a,b){a=a.replace(/[^0-9*]/g,"");if(13!==c.string.trimToEmpty(a).length)return!1;b=0;if(5!=a.substr(6,
1)&&6!=a.substr(6,1)&&7!=a.substr(6,1)&&8!=a.substr(6,1)||0!==Number(a.substr(7,2))%2)return!1;for(var d=0;12>d;d++)b+=Number(a.substr(d,1))*(d%8+2);return((11-b%11)%10+2)%10==Number(a.substr(12,1))?!0:!1},frn_rrn:function(a,b){a=a.replace(/[^0-9*]/g,"");return 13!==c.string.trimToEmpty(a).length?!1:5<=Number(a.charAt(6))&&8>=Number(a.charAt(6))?this.frn():this.rrn()},kbrn:function(a,b){a=a.replace(/[^0-9*]/g,"");var d=[1,3,7,1,3,7,1,3,5,1],e;for(e=b=0;7>=e;e++)b+=d[e]*a.charAt(e);d="0"+d[8]*a.charAt(8);
d=d.substring(d.length-2,d.length);b+=Math.floor(d.charAt(0))+Math.floor(d.charAt(1));b=(10-b%10)%10;return Math.floor(a.charAt(9))===b?!0:!1},kcn:function(a,b){a=a.replace(/[^0-9*]/g,"");if(13!==a.length)return!1;a=a.split("");b=[1,2,1,2,1,2,1,2,1,2,1,2];for(var d=0,e=0;12>e;e++)d+=parseInt(a[e])*b[e];return(10-d%10)%10!==a[12]?!1:!0},date:function(a,b){var d=a.replace(new RegExp("\\"+c.context.attr("data").formatter.date.dateSepa,"gi"),"");a=8===c.string.trimToEmpty(d).length?!0:!1;if(!a)return!1;
a=[31,28,31,30,31,30,31,31,30,31,30,31];b=d.substring(0,4);var e=d.substring(4,6);d=d.substring(6,8);if(0===d)return!1;var g=!1,k=!1;0===b%4&&(k=!0,0===b%100&&(k=!1),0===b%400&&(k=!0));k?2==e?d<=a[e-1]+1&&(g=!0):d<=a[e-1]&&(g=!0):d<=a[e-1]&&(g=!0);return g},time:function(a,b){return(new RegExp(/^([01]\d|2[0-3])([0-5]\d){0,2}$/)).test(a.replace(/[^0-9]/g,""))},accept:function(a,b){if(void 0===b||void 0===b[0])throw Error("[Validator.accept]You must input args[0](accept string)");return(new RegExp("^("+
