...
*/
(function(A,h){N.version["Natural-DATA"]="1.0.0";h.fn.extend(h.extend(N.prototype,{datafilter:function(c){return N.data.filter(this,c)},datasort:function(c,v){return N.data.sort(this,c,v)},formatter:function(c){return new N.formatter(this,c)},validator:function(c){return new N.validator(this,c)}}));(function(c){c.data={filter:function(a,b){if("function"===typeof b)return c.isWrappedSet(a)?c(h.grep(a.toArray(),b)):h.grep(a,b);if("string"===c.type(b)){b=b.replace(/ /g,"").replace(/\|\|/g," || item.").replace(/&&/g,
" || item.");var d=new Function("item","return item."+b);return c.isWrappedSet(a)?c(h.grep(a.toArray(),function(e){return d(e)})):h.grep(a,function(e){return d(e)})}return a},sortBy:function(a,b){return function(d,e){d=d[a];e=e[a];Number(d)&&Number(e)&&(d=Number(d),e=Number(e));return d<e?-1*b:d>e?1*b:0}},sort:function(a,b,d){return a.sort(this.sortBy(b,d?-1:1))}};var v=c.ds=function(a,b){if(c.ds.caller!=c.ds.instance)throw Error("[N.datasync]There is no public constructor for N.ds, use instance method");
var d=h(c.context.attr("architecture").page.context);0===d.length&&c.warn('[N.ds]Context element is missing. Please specify the correct Natural-JS\'s main context element selector to "N.context.attr("architecture").page.context" property in "natural.config.js" file');var e=d.find("var#data_sync_temp__");0===e.length&&(e=d.append('<var id="data_sync_temp__"></var>').find("var#data_sync_temp__"));this.viewContext=e;d=this.viewContext.instance("ds");void 0!==d?(d.inst=a,void 0!==b&&!0===b&&d.observable.push(a)):
(d=this,d.inst=a,d.observable=[],d.observable.push(a),this.viewContext.instance("ds",d));return d};h.extend(v,{instance:function(a,b){return new c.ds(a,b)}});h.extend(v.prototype,{remove:function(){var a=this.inst,b=this.observable;if(a&&b)for(var d=0;d<b.length;d++)b[d]==a&&b.splice(d,1);return this},notify:function(a,b){var d=this.inst,e=this.observable;if(d&&e)for(var g=0;g<e.length;g++)d!==e[g]&&d.options.data===e[g].options.data&&(e[g]instanceof c.form?a===e[g].row()&&e[g].update(a,b):e[g].update(a,
b));return this}});var x=c.formatter=function(a,b){this.options={data:c.isPlainObject(a)?c(a):a,rules:b,isElement:!1,createEvent:!0,context:null,targetEle:c()};if(c.isElement(b)||c.isString(b)){var d=this.options;d.isElement=!0;d.context=c(b);if(0<a.length){if(void 0!==a[0][d.context.attr("id")])d.targetEle.push(d.context.get(0));else for(var e in a[0])0<d.context.find("#"+e).length&&d.targetEle.push(d.context.find("#"+e).get(0));d.rules=c.element.toRules(d.targetEle,"format")}}};h.extend(x,{commas:function(a){if(c.isEmptyObject(a))return a;
a=a.replace(/,/g,"");var b=/(^[+-]?\d+)(\d{3})/;for(a+="";b.test(a);)a=a.replace(b,"$1,$2");return a},rrn:function(a,b){if(c.isEmptyObject(a))return a;a=a.replace(/[^0-9*]/g,"");if(13===a.length){var d="*";void 0!==b&&void 0!==b[1]&&(d=b[1]);void 0!==b&&void 0!==b[0]&&(a=c.string.rpad(a.substring(0,13-Number(b[0])),13,d));a=a.substring(0,6)+"-"+a.substring(6,13)}return a},ssn:function(a,b){return 13===a.length?this.rrn(a,b):9===a.length?(a=a.replace(/[^0-9*]/g,""),a.substr(0,3)+"-"+a.substr(3,2)+
"-"+a.substr(5,4)):a},kbrn:function(a){if(5>c.string.trimToEmpty(a).length)return a;a=a.replace(/[^0-9*]/g,"");10<a.length&&(a=a.substring(0,10));return a.substring(0,3)+"-"+a.substring(3,5)+"-"+a.substring(5,10)},kcn:function(a){return this.rrn(a)},upper:function(a){return c.isEmptyObject(a)?a:a.toUpperCase()},lower:function(a){return c.isEmptyObject(a)?a:a.toLowerCase()},capitalize:function(a){if(c.isEmptyObject(a))return a;var b=a.substring(0,1).toUpperCase();1<a.length&&(b+=a.substring(1));return b},
zipcode:function(a){if(c.isEmptyObject(a))return a;a=a.replace(/[^0-9*]/g,"");return a.substring(0,3)+"-"+a.substring(3,6)},phone:function(a){if(c.isEmptyObject(a))return a;a=a.replace(/[^0-9*]/g,"");return a.replace(/(^02.{0}|^01.{1}|[0-9*]{3})([0-9*]+)([0-9*]{4})/,"$1-$2-$3")},realnum:function(a){try{a=String(parseFloat(a))}catch(b){return a}return"NaN"===a?a.replace("NaN",""):a},trimtoempty:function(a){return c.string.trimToEmpty(a)},trimtozero:function(a){return c.string.trimToZero(a)},trimtoval:function(a,
b){if(void 0===b||void 0===b[0])throw c.error("[N.formatter.trimtoval]You must input args[0](default value)");return c.string.trimToVal(a,b[0])},date:function(a,b,d){if(void 0===b)return a;a=a.replace(/[^0-9]/g,"");if(void 0!==c.datepicker){if(void 0!==b[1]&&("date"===b[1]||"month"===b[1])&&void 0!==d&&!d.hasClass("datepicker__")&&d.is("input")){var e,g,k,f={monthonly:"month"===b[1]};void 0!==b[2]&&h.extend(f,b[2]);var l=d.datepicker(f).options,p=l.onBeforeShow;l.onBeforeShow=function(q,w){q.trigger("unformat");
if(null!==p)return p.apply(this,arguments)};var m=l.onSelect;l.onSelect=function(q,w,z){e=w.obj.formatDate(z?"Ym":"Ymd");q.parents(".form__").each(function(){g=h(this).instance("form");if(void 0!==g)return!1});k=q.attr("id");void 0!==g&&e!==g.val(k)&&g.val(k,e);if(null!==m)return m.apply(this,arguments)};var n=l.onBeforeHide;l.onBeforeHide=function(q,w){q.val(q.val().replace(/[^0-9]/g,""));q.trigger("focusout.dataSync.form").trigger("focusout.form.format");if(null!==n)return n.apply(this,arguments)};
var r=l.onHide;l.onHide=function(q,w){if(null!==r)return r.apply(this,arguments)};if(l.yearChangeInput){var u=l.onChangeYear;l.onChangeYear=function(){l.context.trigger("focusout.dataSync.form");if(null!==u)return u.apply(this,arguments)}}if(l.monthChangeInput){var t=l.onChangeMonth;l.onChangeMonth=function(){l.context.trigger("focusout.dataSync.form");if(null!==t)return t.apply(this,arguments)}}}}else c.warn("if you use date or month option, you must import Natural-UI library");if(void 0!==b[0])return d=
c.context.attr("data").formatter.date,b="number"===c.type(b[0])?4===b[0]?c.date.format(a,"Y"):6===b[0]?c.date.format(a,d.Ym()):8===b[0]?c.date.format(a,d.Ymd()):10===b[0]?c.date.format(a,d.YmdH()):12===b[0]?c.date.format(a,d.YmdHi()):14===b[0]?c.date.format(a,d.YmdHis()):c.date.format(a,d.Ymd()):c.date.format(a,b[0]),0<Number(a)?b:""},time:function(a,b){a=a.replace(/[^0-9]/g,"");a=6<c.string.trimToEmpty(a)?c.string.rpad(a,6,"0"):a.substring(0,6);return a=void 0!==b&&void 0!==b[0]&&"2"==b[0]?a.substring(0,
2):void 0!==b&&void 0!==b[0]&&"4"==b[0]?a.substring(0,2)+c.context.attr("data").formatter.date.timeSepa+a.substring(2,4):void 0!==b&&void 0!==b[0]&&"6"==b[0]?a.substring(0,2)+c.context.attr("data").formatter.date.timeSepa+a.substring(2,4)+c.context.attr("data").formatter.date.timeSepa+a.substring(4,6):a.substring(0,2)+c.context.attr("data").formatter.date.timeSepa+a.substring(2,4)},limit:function(a,b,d){if(void 0===b||void 0===b[0])throw c.error("[N.formatter.limit]You must input args[0](cut length)");
if(a.substr(a.length-b[1].length,b[1].length)!==b[1]){void 0!==d&&d.attr("title",a);for(var e=d=0;e<a.length;e++)if(d+=128<a.charCodeAt(e)?2:1,d>b[0])return void 0!==b&&void 0!==b[1]?c.string.trimToEmpty(a.substring(0,e))+b[1]:a.substring(0,e)}return a},replace:function(a,b,d){if(void 0===b||2>b.length)throw c.error("[N.formatter.replace]You must input args[0](target string) and args[1](replace string)");a=a.split(String(b[0])).join(String(b[1]));"undefined"!=typeof b[2]&&"true"==String(b[2])&&(this.vo[d.attr("name")]=
a);return a},lpad:function(a,b){if(void 0===b||2>b.length)throw c.error("[N.formatter.lpad]You must input args[0](fill length) and args[1](replace string)");return c.string.lpad(a,Number(b[0]),b[1])},rpad:function(a,b){if(void 0===b||2>b.length)throw c.error("[N.formatter.rpad]You must input args[0](fill length) and  args[1](replace string)");return c.string.rpad(a,Number(b[0]),b[1])},mask:function(a,b){if(void 0===b||1>b.length)throw c.error("[N.formatter.rpad]You must input args[0](masking rule)");
var d="*";2!==b.length||c.string.isEmpty(b[1])||(d=b[1]);if("phone"===b[0]){a=c.string.trimToEmpty(a);var e=this.phone(a);a=e.substring(0,e.indexOf("-")+1);b=e.substring(e.lastIndexOf("-"),e.length);e=e.replace(a,"").replace(b,"");return a+e.replace(/\d/g,d)+b}if("email"===b[0]){if(a=c.string.trimToEmpty(a),c.validator.email(a)){b="";for(e=0;3>e;e++)b+=d;return a.replace(/@.*/,"").replace(/.{1,3}$/,b)+a.replace(/.*@/,"@")}}else{if("address"===b[0]){a=c.string.trimToEmpty(a);var g="_\uacbd\uae30_\uac15\uc6d0_\ucda9\ubd81_\ucda9\ub0a8_\uc804\ubd81_\uc804\ub0a8_\uacbd\ubd81_\uacbd\ub0a8_\uc81c\uc8fc_";
a=a.split(" ");var k="",f,l,p;h(a).each(function(){f=c.string.trimToEmpty(this);l=f.substring(0,1);p=f.substring(f.length-1,f.length);if(0>g.indexOf("_"+f+"_")&&0>"_\ub3c4_\uc2dc_\uad70_\uad6c_".indexOf("_"+p+"_")){var m="";if(-1<"_\uc74d_\uba74_\ub3d9_\ub9ac_\ub85c_\uae38_\uac00_".indexOf("_"+p+"_")&&(new RegExp(/[^0-9*]/)).test(l)){for(var n=0;n<f.length-1;n++)m+=d;f=m+p}else{for(n=0;n<f.length;n++)m+=d;f=m}}k+=f+" "});return c.string.trimToEmpty(k)}if("name"===b[0]){a=c.string.trimToEmpty(a);if((new RegExp(/^[a-z-?\d\s\.]+$/i)).test(a))return h(a.split("")).map(function(m){return 2<
...
zipcode:function(a){return(new RegExp(/^\d{3}-\d{3}$/)).test(a)},decimal:function(a,b){b=void 0!==b&&void 0!==b[0]?b[0]:10;return(new RegExp(/^-?\d+$/)).test(a)||(new RegExp("^-?\\d*\\.\\d{0,"+String(b)+"}$")).test(a)},phone:function(a,b){return void 0!==b&&void 0!==b[0]&&"true"==b[0]?(new RegExp(/^\d{2,3}-\d{3,4}-\w+|"("")"$/)).test(a):(new RegExp(/^\d{2,3}-\d{3,4}-\d{4}$/)).test(a)},rrn:function(a){a=a.replace(/[^0-9*]/g,"");if(13!==c.string.trimToEmpty(a).length)return!1;var b=a.substring(0,1),
d=a.substring(1,2),e=a.substring(2,3),g=a.substring(3,4),k=a.substring(4,5),f=a.substring(5,6);b=2*b+3*d+4*e+5*g+6*k+7*f;d=a.substring(6,7);e=a.substring(7,8);g=a.substring(8,9);k=a.substring(9,10);f=a.substring(10,11);var l=a.substring(11,12);a=a.substring(12,13);b=11-(b+8*d+9*e+2*g+3*k+4*f+5*l)%11;b%=10;return b!==a?!1:!0},ssn:function(a){return(new RegExp(/\d{3}-\d{2}-\d{4}/)).test(a)},frn:function(a){a=a.replace(/[^0-9*]/g,"");if(13!==c.string.trimToEmpty(a).length)return!1;var b=0;if(5!=a.substr(6,
1)&&6!=a.substr(6,1)&&7!=a.substr(6,1)&&8!=a.substr(6,1)||0!==Number(a.substr(7,2))%2)return!1;for(var d=0;12>d;d++)b+=Number(a.substr(d,1))*(d%8+2);return((11-b%11)%10+2)%10==Number(a.substr(12,1))?!0:!1},frn_rrn:function(a){a=a.replace(/[^0-9*]/g,"");return 13!==c.string.trimToEmpty(a).length?!1:5<=Number(a.charAt(6))&&8>=Number(a.charAt(6))?this.frn():this.rrn()},kbrn:function(a){a=a.replace(/[^0-9*]/g,"");var b=[1,3,7,1,3,7,1,3,5,1],d,e=0;for(d=0;7>=d;d++)e+=b[d]*a.charAt(d);b="0"+b[8]*a.charAt(8);
b=b.substring(b.length-2,b.length);e+=Math.floor(b.charAt(0))+Math.floor(b.charAt(1));e=(10-e%10)%10;return Math.floor(a.charAt(9))===e?!0:!1},kcn:function(a){a=a.replace(/[^0-9*]/g,"");if(13!==a.length)return!1;a=a.split("");for(var b=[1,2,1,2,1,2,1,2,1,2,1,2],d=0,e=0;12>e;e++)d+=parseInt(a[e])*b[e];return(10-d%10)%10!==a[12]?!1:!0},date:function(a){var b=a.replace(new RegExp("\\"+c.context.attr("data").formatter.date.dateSepa,"gi"),"");a=8===c.string.trimToEmpty(b).length?!0:!1;if(!a)return!1;a=
[31,28,31,30,31,30,31,31,30,31,30,31];var d=b.substring(0,4),e=b.substring(4,6);b=b.substring(6,8);if(0===b)return!1;var g=!1,k=!1;0===d%4&&(k=!0,0===d%100&&(k=!1),0===d%400&&(k=!0));k?2==e?b<=a[e-1]+1&&(g=!0):b<=a[e-1]&&(g=!0):b<=a[e-1]&&(g=!0);return g},time:function(a){return(new RegExp(/^([01]\d|2[0-3])([0-5]\d){0,2}$/)).test(a.replace(/[^0-9]/g,""))},accept:function(a,b){if(void 0===b||void 0===b[0])throw Error("[Validator.accept]You must input args[0](accept string)");return(new RegExp("^("+
