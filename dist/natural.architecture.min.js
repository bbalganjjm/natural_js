...
""))return m.abort(),d.warn("[Communicator.submit.success(urlSync option)]The response was stopped because it was different from the URL at the time of the request and the URL at the time of the response."),!1;if(void 0!==a)try{d.isElement(b)?a.call(b,h):a.call(b,c,b.request),h=void 0}catch(g){throw 0<b.errorHandlers.length&&f(b.errorHandlers).each(function(q,n){n.call(b,g,b.request,m,k,a)}),d.error("N.comm.submit.success.callback(url:"+b.request.options.url+")",g);}},error:function(c,k,m){var e=
!1;f(u.errorFilters).each(function(h,g){if(g.call(b,b.request,c,k,m)instanceof Error)return e=!0,!1});if(!e)throw 0<b.errorHandlers.length&&f(b.errorHandlers).each(function(h,g){g.call(b,m,b.request,c,k)}),d.error("N.comm.submit.error(url:"+b.request.options.url+")",m);},complete:function(c,k){f(u.completeFilters).each(function(m,e){if(e.call(b,b.request,c,k)instanceof Error)return!1})}}),this.xhr=d.ajax(b.request.options),b},error:function(a){this.errorHandlers.push(a);return this}});t.request=function(a,
b){this.options={referrer:x.location.href,contentType:"application/json; charset=utf-8",cache:!1,async:!0,type:"POST",data:null,dataIsArray:!1,dataType:"json",urlSync:!0,crossDomain:!1,browserHistory:!0,append:!1,target:null};try{f.extend(this.options,d.context.attr("architecture").comm.request.options)}catch(l){}f.extend(this.options,b);this.attrObj={};this.obj=a;if(null===this.options.data){if(d.isWrappedSet(a)){if(!d.isElement(a))try{if(this.options.data=this.options.dataIsArray?a.get():a.get(0),
this.options.dataIsArray&&"array"===d.type(this.options.data)||"object"===d.type(this.options.data))this.options.data=JSON.stringify(this.options.data)}catch(l){this.options.data=null}}else if(null!=a)try{this.options.data=a,"object"===d.type(this.options.data)&&(this.options.data=JSON.stringify(a))}catch(l){this.options.data=null}null!=this.options.data&&"GET"===this.options.type.toUpperCase()&&(a=this.options.data.charAt(0),b=this.options.data.charAt(this.options.data.length-1),"{"===a&&"}"===b||
"["===a&&"]"===b)&&(this.options.data="q="+encodeURI(this.options.data))}};f.fn.extend(t.request.prototype,{attr:function(a,b){if(void 0===a)return this.attrObj;if(void 0===b)return void 0!==this.attrObj&&void 0!==this.attrObj[a]?this.attrObj[a]:void 0;void 0===this.attrObj&&(this.attrObj={});this.attrObj[a]=b;return this.obj},removeAttr:function(a){void 0!==this.attrObj[a]&&delete this.attrObj[a];return this},param:function(a){if(d.isEmptyObject(a)){if(0>this.options.url.indexOf("?"))return{};a=
