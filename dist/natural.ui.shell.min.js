...
*/
(function(r,g){N.version["Natural-UI.Shell"]="0.10.48";g.fn.extend(g.extend(N.prototype,{notify:function(e){return new N.notify(this,e)},docs:function(e){return new N.docs(this,e)}}));(function(e){var t=e.notify=function(a,c){if(1===arguments.length&&!e.isEmptyObject(a))return new e.notify(null,a);this.options={position:{top:10,right:10},container:e("body"),context:null,displayTime:7,alwaysOnTop:!1,html:!1,alwaysOnTopCalcTarget:"div, span, ul, p, nav, article, section, header, footer, aside"};try{g.extend(this.options,
