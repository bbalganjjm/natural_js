...
this.options.url.indexOf("?"))return{};a={};for(var b=this.options.url.split("?")[1].substring(1).split("&"),f=0;f<b.length;f++){var c=b[f].split("=");c[0]&&(a[c[0]]=decodeURIComponent(c[1])||!0)}return a}return this.param()[a]},get:function(a){return void 0!==a?this.options[a]:this.options}});var m=d.cont=function(a,b){void 0!==a.attr("id")&&1<d("[id='"+a.attr("id")+"']").length&&(a=d("#"+a.attr("id")+":not(.view_context__)"));var f=a.selector;1<a.length&&(a=d(a.selector+":not(.view_context__)"),
a.selector=f);a.attr("data-pageid",a.attr("id")?a.attr("id"):a.selector.replace(/\.|\#|\[|\]|\'|\:|\(|\)|\>| |\-/gi,""));a.addClass("view_context__");a.instance("cont",b);b.view=a;return b};f.extend(m,{trInit:function(a,b){a.request=b;m.aop.wrap.call(this,a);void 0!==a.init&&a.init(a.view,b)},aop:{pointcuts:{regexp:{fn:function(a,b,d){return(a instanceof RegExp?a:new RegExp(a)).test(d)}}},wrap:function(a){if(d.context.attr("architecture").cont&&d.context.attr("architecture").cont.advisors&&0<d.context.attr("architecture").cont.advisors.length){var b=
d.context.attr("architecture").cont;f(b.advisors).each(function(h,c){var g;d.isPlainObject(c.pointcut)||(c.pointcut={type:"regexp",param:c.pointcut},d.isString(c.pointcut.param)&&(c.pointcut.selector=c.pointcut.selector||c.pointcut.param.substring(0,c.pointcut.param.lastIndexOf(":")),c.pointcut.param=c.pointcut.param.substring(c.pointcut.param.lastIndexOf(":")+1)));(g=b.pointcuts?b.pointcuts[c.pointcut.type]||m.aop.pointcuts[c.pointcut.type]:m.aop.pointcuts[c.pointcut.type])||d.error("[Controller]Unkown pointcut type : "+
c.pointcut.type);if(!c.pointcut.selector||a.view.is(c.pointcut.selector)){var n=function(a,b){for(var e in a)a.hasOwnProperty(e)&&(f.isFunction(a[e])?g.fn(c.pointcut.param,a,b+e)&&(a[e]=function(d,f){switch(c.adviceType){case "before":var e=function(){var e=[].slice.call(arguments);c.fn.call(c,a,b+f,e);return d.apply(a,e)};break;case "after":e=function(){var e=[].slice.call(arguments),g=d.apply(a,e);c.fn.call(c,a,b+f,e,g);return g};break;case "around":e=function(){var e=[].slice.call(arguments);return c.fn.call(c,
a,b+f,e,{contFrag:a,args:e,real:d,proceed:function(){return this.real.apply(this.contFrag,this.args)}})};break;case "error":e=function(){var e=[].slice.call(arguments);try{var g=d.apply(a,e)}catch(v){if("error"==c.adviceType)g=c.fn.call(c,a,b+f,e,v);else throw v;}return g}}return e}(a[e],e)):d.isPlainObject(a[e])&&n.call(this,a[e],b+e+"."))};n.call(this,a,"")}})}}}});d.context={attrObj:{},attr:g.request.prototype.attr}})(N)})(window,jQuery);
